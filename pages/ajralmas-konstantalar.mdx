...
E'tibor bering, `Number.EPSILON{:js}` - bu bir va birdan katta bo'lgan eng kichik son orasidagi farqni ifodalaydi va shuning uchun ikki xil Number qiymatlar orasidagi mumkin bo'lgan eng kichik farq. Bundan foydalanishning sabablaridan biri raqamlarning JavaScriptda qanday saqlanishi xususiyati bilan bog'liq. Qarang: Ikki raqamning tengligini tekshirish
