...
ECMAScript 5 dan oldin siz `globalThis.undefined{:js}` xususiyati qiymatini hamma narsani buzishi mumkin bo'lgan boshqa qiymatga o'zgartirishingiz mumkin edi.
