...
Bu global obyektning xossasi va `Number.NaN{:js}` ga havola
...
`undefined{:js}` - bu kompilyatorda qiymatning yo'qligi, chunki u tayinlanmagan o'zgaruvchi kabi, kerakli joyda qiymat qo'yilmagan.
